...
\begin{itemize}
	...
	As I was not getting the colors and the shapes I had to use the code scale_shape_manual and type the colors I want to use, I did the same for shapes scale_shape_manual and type the figures I wanted in my graph. 
